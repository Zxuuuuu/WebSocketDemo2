...
import com.example.websocketdemo2.stomp.provider.OkHttpConnectionProvider;
import com.example.websocketdemo2.stomp.provider.WebSocketsConnectionProvider;
...
public class Stomp {
    ...
    private static StompClient createStompClient(com.example.websocketdemo2.stomp.provider.ConnectionProvider connectionProvider) {
